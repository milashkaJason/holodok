...
<html>
<head>
    <title>Заправка кондиционера в Минске</title>
    ...
    <script src="https://api-maps.yandex.ru/2.1/?apikey=c31d9a3b-860a-41f0-b8fb-708a953e14c3&lang=ru_RU"
    ...
    <div class="container">
        <div class="row bg-header-flex">
            <div class="col-md-6 col-sm-6 col-xs-6 text-left">
                <h4 class="text-left ask_title fonts_def_1 font_size_25">
                    <img width="200" src="image/logo-holodno-v-2.png" alt="">
                </h4>
            </div>
...
<section>
    <div class="fire-bg">
        <h2 class="wow rubberBand2"><span>ДАЕМ ОТПОР</span> ЖАРЕ!</h2>
        <img class="fire-img" src="image/fire.jpg" alt="">
        <h3 class="fire-bg-sub-title">Победа будет за нами</h3>
    </div>
</section>
        ...
        <div class="row wow bounceInUp">
            ...
            <div class="col-lg-8">
                <div class="picture_slider text-center ">
                    <img class="picture-img" src="image/ystanovka.jpg">
                </div>
            </div>
            <div class="col-sm-12 col-12 col-lg-4 bg-slider-title-block">
                <div class="">
                    <ul class="about_product_sub_title">
                        <li class="fonts_def_1">Диагностика и поиск неисправности нерабочей системы</li>
                        <li class="fonts_def_1">Ремонт и устранение причины неисправности с последующей заправкой</li>
                        <li class="fonts_def_1">Бесплатный выезд в удобное время</li>
                    </ul>
                    <p class="fonts_def_1 about_product_title_3">Цена от: <span class="color_rer">27 руб!</span> (при
                        заказе с сайта)</p>
                </div>
            </div>
        </div>
...
<!--Устали от жары? Значит, мы едем к вам!!-->
<section class="bg-slider">
    <div class="container">
        <div class="row wow bounceInUp">
            <div class="col-md-12">
                <h1 class="bg-slider-title text-center fonts_def_1 title-konder">Устали от жары? Значит, мы едем к
                    вам!!</h1>
            </div>
            <div class="col-lg-8">
                <div class="picture_slider text-center row">
                    <div class="col-md-6 col-xs-6">
                        <img class="picture-img pavki-1" src="image/egg.jpg">
                    </div>
                    <div class="col-md-6 col-xs-6">
                        <img class="picture-img pavki-1" src="image/girl.jpg">
                    </div>
                </div>
            </div>
        </div>
...
<section class="bg-slider">
    <div class="container">
        <div class="row wow bounceInUp">
            <div class="col-md-12">
                <h1 class="bg-slider-title text-center fonts_def_1 title-konder">Победа будет за нами</h1>
            </div>
            <div class="col-lg-8">
                <div class="picture_slider text-center row">
                    <div class="col-md-6 col-xs-6">
                        <img class="picture-img pavki-2" src="image/gory.jpg">
                    </div>
                    <div class="col-md-6 col-xs-6">
                        <img class="picture-img pavki-2" src="image/wheater.jpg">
                    </div>
                </div>
            </div>
        </div>
...
<section class="">
    <div class="container">
        <div class="row">
            ...
            <div data-wow-delay="0.1s" class="col-md-4 wow bounceInLeft">
                <h4 class="text-center fonts_def_1 title_workP">1 этап</h4>
                <p class="text-center fonts_def_1 descr_workp">Ваша заявка, запись</p>
            </div>
            <div data-wow-delay="0.1s" class="col-md-4 wow bounceInUp">
                <h4 class="text-center fonts_def_1 title_workP">2 этап</h4>
                <p class="text-center fonts_def_1 descr_workp">Проверка работоспособности</p>
            </div>
            <div data-wow-delay="0.1s" class="col-md-4 wow bounceInRight">
                <h4 class="text-center fonts_def_1 title_workP">3 этап</h4>
                <p class="text-center fonts_def_1 descr_workp">Заправка, в случае работоспособности системы</p>
            </div>
            `
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div data-wow-delay="0.2s" class="col-md-4 wow bounceInRight about_auto">
                ...
                <p class="box_li fonts_def_1 text-coment">Приехал на заправку кондиционера на Renault Laguna 2.
                    Но в процессе заправки обнаружилась проблема, на месте нашли проблему( был забит осушитель)на
                    следующий день поменяли осушитель и клапан распылитель. Заправили кондиционер (все холодит) .
                    Сделали скидку на заправку.
                    Плюсом является низкая стоимость, качество, клиентооринтированность и советы по эксплуатации
                    кондиционера.
                </p>
            </div>
...
<section class="bg-plasti_window">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="box6-title">
                    <span>Как к нам доехать</span>
                </h3>
            </div>
        </div>
        <div data-wow-delay="0.1s" class="text-center wow rubberBand">
        ...
        <div class='row footer-text'>
            <div class="col-md-6 footer-right">
                <ul class="footer-list">
                    <li><strong>Телефон: </strong><a class="phone-link" href="tel:+375255259000">+375 25 525 9000</a>
                    </li>
                    <li><strong>E-mail: </strong> <a href="mailto:bymaximus17@gmail.com" class="mail-link"
                                                     title="e-mail">example17@gmail.com</a></li>
...
<script type="text/javascript">
    ...
    function init() {
        ...
        var myMap = new ymaps.Map('map', {
            ...
            center: [53.839902, 27.544869], // Нижний Новгород
            zoom: 17
        });
